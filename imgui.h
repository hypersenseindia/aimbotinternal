...
typedef int ImGuiAddintionalFunc;
...
namespace ImGui
{
    ...
    //    BeginPopup/EndPopup, etc. where the EndXXX call should only be called if the corresponding BeginXXX function
    //    returned true. Begin and BeginChild are the only odd ones out. Will be fixed in a future update.]
    IMGUI_API bool          BeginChild(const char* str_id, const ImVec2& size = ImVec2(0, 0), bool border = true, ImGuiWindowFlags flags = 0);
    IMGUI_API bool          BeginChild(ImGuiID id, const ImVec2& size = ImVec2(0, 0), bool border = true, ImGuiWindowFlags flags = 0);
    IMGUI_API void          EndChild(bool popstylevar = true);
    ...
    void                    TextColoredAnim(const char* key, const ImVec4& col, const char* fmt, ...);
...
enum ImGuiAddintionalFunc_
{
    ImGuiAddintionalFunc_None = 0,
    ImGuiAddintionalFunc_Keybind = 1,
    ImGuiAddintionalFunc_Picker = 2
};
